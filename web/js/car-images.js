...
let nextBtn, prevBtn, imgNameWithoutExtension, extension, getLatestOpenedImg;
...
function changeImage(changeDirection) {
  ...
  let newImgName = imgNameWithoutExtension.substring(
    0,
    imgNameWithoutExtension.length - 1
  );

  newImage.setAttribute(
    'src',
    '../uploads/' + newImgName + calcNewImage + '.' + extension
  );
